...
console.log(friendInfo,"info");
    ...
    return (
        <>
        <button onClick={handleCall} className="bg-[#f8fafc] hover:bg-slate-100 border border-slate-100 p-6 rounded-lg flex flex-col items-center gap-3 transition-all group">
              ...
              <button onClick={handleText} className="bg-[#f8fafc] hover:bg-slate-100 border border-slate-100 p-6 rounded-lg flex flex-col items-center gap-3 transition-all group">
                <div className="p-3 bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform">
              ...
              <button onClick={handleVideo} className="bg-[#f8fafc] hover:bg-slate-100 border border-slate-100 p-6 rounded-lg flex flex-col items-center gap-3 transition-all group">
                <div className="p-3 bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform">
